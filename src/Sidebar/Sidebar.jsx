    ...
    <div>
      ...
      >
        <ul className="space-y-[2px] w-full">
          <li className=" rounded-md bg-_white p-pl_primary group hover:cursor-pointer duration-200 ">
            <div
            ...
            >
              ...
              <li className="9 px-p_md py-p_xs hover:cursor-pointer  duration-200  py-pt_primary bg-bg_state text-_black px-pl_primary rounded-rounded_primary">
                ...
                >
                  General Knowledge{" "}
                  <span className="bg-text_orange text-white text-xs px-pl_primary rounded-sm">
                    Premium
                  </span>
                </Link>
              </li>
